...
// muchos pokemones para muchos types y viceverza
...
sequelize
  .authenticate()
  .then(() => {
    console.log('Conexión exitosa con la base de datos GG');
  })
  .catch((error) => {
    console.error('Error al conectar con la base de datos: FF ', error);
  });
